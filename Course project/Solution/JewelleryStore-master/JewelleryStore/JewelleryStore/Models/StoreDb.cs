...
public partial class StoreDb : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=localhost,1433;Database=AppDB;User Id=sa;Password=aaaa_1111;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True");
    }
