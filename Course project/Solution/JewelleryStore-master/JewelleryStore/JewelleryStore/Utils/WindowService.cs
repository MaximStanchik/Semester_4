        ...
        public static Uri GetPage(Pages page)
        {
            ...
            switch(page)
            {
                ...
                case Pages.ProductsPage:
                    ...
                    break;
                case Pages.StockPage:
                    uri = new Uri("pack://application:,,,/Views/StockPage.xaml");
                    break;
                case Pages.AccPage:
                    uri = new Uri("pack://application:,,,/Views/AccPage.xaml"); 
                    break;
                case Pages.UserAccPage:
                    uri = new Uri("pack://application:,,,/Views/UserAccPage.xaml");
                    break;
                case Pages.PromosPage:
                    uri = new Uri("pack://application:,,,/Views/DeleteStocks.xaml");
                    break;
                case Pages.OrderListPage:
                    uri = new Uri("pack://application:,,,/Views/OrderList.xaml");
                    break;
                default:
                    uri = null;
                    break;
