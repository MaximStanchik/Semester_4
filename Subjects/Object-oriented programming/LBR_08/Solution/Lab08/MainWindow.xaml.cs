...
namespace Lab08
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void CheckConnection()
        {
            ...
            using (connection = new SqlConnection("Server=localhost,1433;Database=Planets;User Id=sa;Password=aaaa_1111;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True"))
            { //"Server=localhost,1433;Database=AppDB;User Id=sa;Password=aaaa_1111;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True"
                try
                {
                    connection.Open();
                }
                ...
                {
                    connection.Close();
                    connectionString = "Server=localhost,1433;Database=Planets;User Id=sa;Password=aaaa_1111;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True";
