namespace OpenFolderChoosePicture
{
    partial class Form1
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Заменить картинку в ноутбуке картинкой из пиктуребакс";
            ...
            this.button2.Text = "Выбрать картинку в пикатурубаксик";
